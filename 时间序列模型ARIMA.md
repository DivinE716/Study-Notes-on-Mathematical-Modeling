...
1. **差分（Differencing）**：这是一种预处理技术，用于使非平稳时间序列变得平稳。在时间序列中进行一阶差分，就是将每个观察值与其前一步的观察值进行比较，然后取这两个观察值之间的差异。例如，如果我们有一个时间序列 $x_1, x_2, x_3, \dots, x_n$，那么一阶差分序列将是 $x_2 - x_1, x_3 - x_2, \dots, x_n - x_n-1$。 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3NzcyNjkwOSwxMTI0MzU2ODg4LDE4MD
